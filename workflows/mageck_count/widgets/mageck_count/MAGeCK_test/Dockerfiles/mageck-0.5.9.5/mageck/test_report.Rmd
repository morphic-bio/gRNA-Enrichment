...
genreporttable<-function(cpname,genetb){
  ...
  #genetb=read.table(genesummaryfile,header = T,as.is = T, sep = '\t')
...
```{r}
gstable=read.table(gene_summary_file,header = T,as.is = T,na.strings='', sep = '\t')
sg_table=read.table(sgrna_summary_file,header = T,as.is = T,na.strings='', sep = '\t')
